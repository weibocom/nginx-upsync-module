...
reload造成的性能影响：
![consul-template-qps](https://github.com/weibocom/nginx-upsync-module/doc/images/consul-template-reload-qps.png)
在27s的时候进行的reload，nginx的请求处理能力会下降（注：nginx对于握手成功的请求不会丢失）。
![consul-template-cost](https://github.com/weibocom/nginx-upsync-module/doc/images/consul-template-reload-cost.png)
...
![http-api architecture](https://github.com/weibocom/nginx-upsync-module/doc/images/nginx-http-api-arch.png)
...
![upsync architecture](https://github.com/weibocom/nginx-upsync-module/doc/images/nginx-upsync-arch.png)
...
![upsync follow](https://github.com/weibocom/nginx-upsync-module/doc/images/list_update.bmp)
...
![start follow](https://github.com/weibocom/nginx-upsync-module/doc/images/start_fllow.bmp)
...
![reload vs upsync](https://github.com/weibocom/nginx-upsync-module/doc/images/upsync-vs-reload-qps.png)
...
![reload vs upsync](https://github.com/weibocom/nginx-upsync-module/doc/images/upsync-vs-reload-cost.png)
...
模块地址：https://github.com/weibocom/nginx-upsync-module，欢迎大家使用，任何问题欢迎随时交流。
